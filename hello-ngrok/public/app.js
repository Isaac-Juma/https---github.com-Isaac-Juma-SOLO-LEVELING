...
let items = [
  {title: 'STUDY', body : 'STUDY FOR 30 MINS ' }, 
  ...
  {title: 'HYGINE', body: 'COLD SHOWER'},
  {title: 'ATTITUDE', body: 'LET IT GO AND EXP THE WORKD'}, 
  {title: 'SKILLS', body: 'PRACTICE YOUR SKILLS EVERYDAY'},
  {title: 'COMMUNICATION', body: 'PRACTICE COMMUNICATION DAILY'} ];
  ...
  let Mission = [
    ...
    {title: 'title 5', body: 'COLD SHOWER IN THE MORNING WILL INCREASE YOUR CIRCULATION, ALERTNESS AND WILLPOWER'},
    {tile: 'title 6', body: 'ATTITUDE IS EVERYTHING, LET GO OF THE PAST AND EMBRACE THE FUTURE WITH OPEN ARMS AND A POSITIVE MINDSET'},
    {title: 'title 7', body: 'SKILLS ARE THE BUILDING BLOCKS OF SUCCESS, PRACTICE DAILY TO MASTER YOUR CRAFT'},
    {title: 'title 8', body: 'COMMUNICATION IS KEY TO BUILDING STRONG RELATIONSHIPS, PRACTICE ACTIVE LISTENING AND CLEAR EXPRESSION DAILY'}
];
...
function SysUpdater () {
  ...
  if (CheckDone.checked) {
    ...
    if (CurrentItem < items.length) {
      Showitem.innerHTML = items[CurrentItem].title;
      CurrentItem++;
      
      if (miss < Mission.length) {
        MissionDisplay.innerText = Mission[miss].body;
        miss++;
      }
